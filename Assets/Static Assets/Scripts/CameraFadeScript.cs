...
{
    [Tooltip("Time to wait before fading the screen in or out.")]
    ...
    public void StartFade(Color newScreenOverlayColor, float duration)
    {
        if (duration <= 0) SetScreenOverlayColor(newScreenOverlayColor);
        else
        {
